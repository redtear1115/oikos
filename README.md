...
| 版本 | 主題 |
|---|---|
| [v1.5.18](CHANGELOG.md#1518---2026-09-21) | 愛物列表先看見關係再看見金額 · 過去章節不再排出 NT$0 · 刪除確認說實話 · 守護的失敗不再靜默 · 頭貼可以隱藏 · Landing 說得出 iPhone 版已上架 |
| [v1.5.17](CHANGELOG.md#1517---2026-09-19) | 記帳錯誤提示不再擋住按鈕 · App 冷啟動不再被登入畫面打斷 · Android App Google 登入走得完 · iOS App 登入第一次點就有反應 · 登入錯誤進 Sentry Issue |
| [v1.5.16](CHANGELOG.md#1516---2026-09-17) | 網址不再外流 · 自家的 404 與錯誤頁 · 登入後回原頁 · landing 手機版收尾 · README 與 CHANGELOG 改版 |
