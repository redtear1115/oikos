...
export const zhCN: Translations = {
  ...
  landing: {
    ...
    jsonLdFaq: [
      ...
      },
      {
        question: '数据安全吗？',
        answer:
          '账本只开放给你和伴侣两人，连接以 HTTPS 加密。身份证号、车牌、住址等敏感字段会加密存储，记账内容不分享、不出售。',
      },
    ],
  ...
  outingList: {
    ...
    empty: {
      heading: '还没有出游',
      body: '约朋友出门时，开一个出游，谁付了什么、谁该还谁，一起看得清楚。',
    },
  },
  ...
  outing: {
    ...
    untitledExpense: '一笔支出',
    emptyExpenses: '还没有支出。记下第一笔吧。',
    addExpense: '记一笔',
    addParticipant: '加一个人',
    settle: '标记还款',
    endOuting: '结束出游',
    endedNote: '这次出游已经结束。',
    coupleFoldNote: '结束后，你们俩的 {amount} 会折回主账本。',
    endConfirmTitle: '结束这次出游',
    foldSettlementNote: '出游『{name}』结算',
    memberFallbackName: '成员',
    endConfirmBody: '结束后就不能再记账了。你们俩之间的部分会折回主账本，朋友的部分留在这里结算。',
    form: {
      nameLabel: '出游名称',
      namePlaceholder: '例如：九份两日',
      saveCreate: '开始',
      payerLabel: '谁付的',
      amountLabel: '金额',
      splitLabel: '分给谁',
      descriptionLabel: '备注（选填）',
  ...
  settings: {
    ...
    dangerZone: {
      ...
      removeFlow: {
        title: '移除 {partner}',
        body: '{partner} 会离开这本账本，账本回到你一个人记录。新的一段从现在开始；之前的记录留在原地，之后可以回头查看。',
        bullets: [
          '{partner} 之后看不到这本账本',
          '尚未接受的邀请链接会失效',
          '之前的记录留在这段章节里，之后只能查看，不能再变动',
          '这个操作没有办法恢复',
        ],
      ...
      errors: {
        ...
        onlyMemberACanRemove: '只有主账号可以移除对方',
        balanceNotZero: '还有差额没结清，无法离开',
        soloGroup: '已经是单人账本',
        activeTrip: '这本账本目前有进行中的旅行，请先到「旅行」把它标记为结束，才能移除对方',
        activeOuting: '这本账本目前有进行中的出游，请先到「出游」把它标记为结束，才能移除对方',
        fallback: '操作失败，请稍后再试',
      },
    },
    import: {
  ...
  termsPage: {
    ...
    bullets: [
      ...
      '您可随时通过设置页登出或删除账号。提出删除后有 14 天缓冲期，期间可以取消；期满后，只有您一个人的账本会整本删除，与伴侣共用的账本则会留给对方，您和对方共同记下的记录不会一起移除。详见隐私政策的「数据保留期限」。',
  ...
  privacyPage: {
    ...
    sectionCollectItems: [
      'Google 或 Apple 登录提供的基本账号信息：姓名、头像、Email 地址。',
...
2026-05-30,工资,50000,五月,TWD,income`,
  ...
  errors: {
    actions: {
      ...
      amount_invalid: '金额需为整数',
      amount_too_large: '金额过大',
      outing_not_found: '找不到这次出游',
      outing_not_active: '这次出游已经结束',
      outing_epoch_closed: '这次出游在过去的章节里，只能结束',
      outing_participant_not_found: '找不到这位参与者',
      outing_participant_limit: '一次出游最多 20 人',
      outing_name_empty: '出游名称为空',
      outing_name_too_long: '出游名称最长 100 字',
      outing_participant_name_empty: '名字为空',
      outing_participant_name_too_long: '名字最长 40 字',
