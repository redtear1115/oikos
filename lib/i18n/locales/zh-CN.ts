...
export const zhCN: Translations = {
  ...
  termsPage: {
    ...
    outro: '如有任何疑问，请通过 support@futari.southern-light.dev 联系我们。',
    backHome: '← 回首页',
    privacyLink: '隐私权政策',
  },
  ...
  privacyPage: {
    ...
    sectionRightsBody: '您可随时通过设置页登出或删除账号。如需导出或查询您的个人数据，请通过 support@futari.southern-light.dev 联系我们。',
    outro: '本政策若有变更，将在本页更新并修改日期。如有任何疑问，请通过 support@futari.southern-light.dev 联系我们。',
    backHome: '← 回首页',
    termsLink: '服务条款',
  },
