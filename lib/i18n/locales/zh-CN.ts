  ...
  signIn: {
    ...
    about: {
      ...
      s1Body: [
        ...
        '后来我就想，要不自己做一个。不是要做什么伟大的产品，只是想要一个从一开始就假设「使用者是两个人」的记账工具。这就是 Futari 的起点。',
      ],
      ...
      s6Heading: '记账 app 会不会突然消失？我们的资料怎么办？',
      s6Body: [
        '这个担心很合理。Honeydue 这几年慢慢式微，Spendee 曾经让用户的资料凭空消失——如果你被这些事吓过，你的警觉是对的。',
        'Futari 是我自己每天在用的工具，这是最直接的「有人在维护」的证明。不是说它永远不会出问题，而是说背后有一个真实的人在意它能不能用。',
        '资料方面，Futari 支持 CSV 导出。任何时候你想把资料带走，都可以。我不想用「我们不会消失」这种话来说服你，但我可以告诉你：你的资料不会被绑住。',
      ],
