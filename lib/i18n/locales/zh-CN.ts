...
export const zhCN: Translations = {
  ...
  assetDetail: {
    ...
    savings: {
      ...
      accountValueHint: '投资型保单 · 从对账单抄写',
      recurringSectionTitle: '让系统帮忙提醒',
      recurringSectionHint: '把分红 / 生存金变成定期进账，到时候只要点一下确认',
      recurringSectionCta: '设定定期进账 →',
      recurringSectionCtaExisting: '已设定 {count} 项定期进账 →',
