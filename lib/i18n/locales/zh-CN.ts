...
export const zhCN: Translations = {
  ...
  importPage: {
    title: '导入历史记录',
    back: '返回',
    pageHeading: '把过去的记录搬进来',
    pageSubtitle: '支持从 Honeydue、Spendee、CWMoney 导出的 CSV。文件会在你的浏览器解析，只有按下导入时才会写入。',
    ...
    upload: {
      prompt: '把 CSV 拖到这里，或选择文件',
      button: '选择 CSV',
      constraint: '上限 2 MB / 5000 列。文件会在这台设备解析。',
      parsing: '解析中…',
      parseError: '读不懂这个文件，确认是 CSV 后再试一次。',
      tooLarge: '文件超过 2 MB，请拆成多份导入。',
      tooManyRows: '文件超过 5000 列，请拆成多份导入。',
      detectedHeading: '已识别到',
      detectedSource: '来源 · {source}',
      rowCounts: '共 {total} 列 · 可导入 {valid} 列 · 有问题 {invalid} 列',
      previewHeading: '前 5 列预览',
      previewCaption: '只是看一眼。实际内容会在后续步骤调整。',
      col: {
        date: '日期',
        type: '类型',
        amount: '金额',
      ...
      noRowsValid: '这个文件没有可导入的数据。确认格式后再试一次。',
    },
    categoryMap: {
      heading: '映射分类',
      body: '把 CSV 里的分类对到 Futari 的分类。默认用相近字猜，可以手动改。',
      empty: '这份文件没有额外的分类要映射。',
      columnFrom: 'CSV 分类',
      columnTo: 'Futari 分类',
      unmappedHint: '没选会落到「其他」',
    },
    payerSplit: {
      heading: '默认付款人与分摊',
      body: '文件里没有付款人信息时，会套用这里的默认。',
      payerLabel: '默认付款人',
      payerViewer: '我',
      payerPartner: '对方',
      splitLabel: '默认分摊',
    ...
    confirm: {
      heading: '确认后开始导入',
      body: '导入会建立一笔「批次」记录，方便日后查看来源。',
      expenseCount: '支出 {n} 笔',
      incomeCount: '收入 {n} 笔',
      skipCount: '跳过 {n} 笔',
      duplicatesHeading: '与既有记录重复的列',
      duplicatesEmpty: '没有与既有记录相同的列。',
      duplicatesShow: '展开',
      duplicatesHide: '收起',
      skipDuplicatesToggle: '自动跳过重复的列',
      skipDuplicatesHint: '同一天、同人、同金额、同分类、备注前 10 字相同的列会被视为重复。',
      checkingDuplicates: '比对重复中…',
      duplicateCheckError: '重复比对失败，仍可继续导入。',
    },
    result: {
      successHeading: '导入完成',
      successBody: '记录已经进入这本账本。可以到记录页看看。',
      counts: '写入 {imported} 笔 · 跳过 {skipped} 笔',
      goToRecords: '去看记录',
      importAnother: '再导入一份',
      errorHeading: '导入没有完成',
      errorBody: '这次的数据整批回退了，没有任何记录被写入。',
      tryAgain: '再试一次',
    },
    sources: {
      honeydue: 'Honeydue',
