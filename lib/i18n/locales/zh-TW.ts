...
2026-05-30,薪水,50000,五月,TWD,income`,
  ...
  seo: {
    ...
    migrate: {
      ...
      'fortune-city': {
        ...
        description: '記帳城市的 CSV 匯出要訂閱，匯出檔還可能要自己轉編碼？截圖請 ChatGPT 整理成 CSV，搬到 Futari 這個專為夫妻、伴侶設計的共同帳本，不再自己蓋城市，兩個人一起記帳。免費、無廣告、只開放給你們倆。',
    ...
    useCase: {
      ...
      roommates: {
        title: '室友分攤帳｜同住費用怎麼分？Futari',
        description: '房租、水電、日常開銷怎麼和室友分攤？Futari 是專為兩人設計的帳本，支援對半、按比例等多種分攤模式，清楚記下每筆同住費用，不再靠記憶追帳。',
        ogDescription: '室友分攤最清楚的帳本工具——Futari，每筆記清楚，不用靠記憶。',
      },
      'monthly-bills': {
  ...
  useCase: {
    ...
    pages: {
      ...
      travel: {
        heroKicker: '旅行費用分攤',
        heroTitle: '這趟旅行，到底誰出了多少？',
        heroSubtitle: '訂房他付、計程車我付、行程中零碎消費——旅行最容易讓帳亂掉。Futari 旅行子帳本讓出遊支出跟日常帳分開，回來之後清清楚楚。',
        painPoints: [
          {
            heading: '「回國之後，根本算不清楚誰多付了多少。」',
            body: '旅行支出分散在訂房、交通、餐廳、伴手禮——沒有一個地方記，回來就只能憑記憶對帳。Futari 旅行子帳本讓每筆旅行費用即時記下來，回國馬上看見結算。',
          },
          {
            heading: '「旅行帳混在日常帳裡，月底完全看不懂。」',
            body: '旅行是特殊支出，不應該跟日常開銷混在一起。Futari 讓旅行帳獨立存在，平常看不干擾，想回顧就清楚。',
          },
          {
            heading: '「多幣別消費，換算起來很麻煩。」',
            body: 'Futari 旅行子帳本支援多幣別記帳，出國刷日幣、港幣都可以記，回來自動換算成主幣別，不用手動算匯率。',
          },
        ],
        faq: [
          {
            question: '旅行費用怎麼和另一半分攤比較清楚？',
            answer: '建議旅行期間用 Futari 旅行子帳本即時記帳——每筆消費記下是誰付的，回來之後直接看結算，不用在群組裡翻聊天記錄。',
          },
          {
            question: 'Futari 旅行子帳本支援多幣別嗎？',
            answer: '支援。旅行子帳本可以設定旅行主幣別，每筆費用記下原始金額，系統依匯率換算成主帳本幣別，方便結算。',
          },
          {
            question: '旅行結束後帳本會怎樣？',
            answer: '旅行結束後，這段旅行的帳本可以封存，裡面的費用也會摺回主帳本計入餘額。記錄永遠在，隨時可以回頭看。',
          },
        ],
      },
      roommates: {
        heroKicker: '同住費用分攤',
        heroTitle: '租屋同住，費用要怎麼記才不傷感情？',
        heroSubtitle: '房租、水電、網路、日常用品——同住費用零碎又頻繁。Futari 讓兩個人把帳放在同一個地方，不用靠記憶追誰欠誰。',
        painPoints: [
          {
            heading: '「上個月的電費到底誰付了、付多少？」',
            body: '同住費用最容易忘，因為每筆都不大，但累積起來差距不小。Futari 讓每筆費用即時記下來，月底不用再翻訊息對帳。',
          },
          {
            heading: '「按比例分還是對半分？每次都要重新算。」',
            body: '沒有對錯，只有適合你們的方式。Futari 支援對半、按比例、全額等多種分攤模式，選一次設定好，之後自動套用。',
          },
          {
            heading: '「一方先墊，另一方記不清楚要還多少。」',
            body: 'Futari 的餘額功能讓你隨時看到目前誰多付了多少，不需要特別去問，也不需要靠記憶。',
          },
        ],
        faq: [
          {
            question: '室友分攤費用用什麼 app 比較好？',
            answer: 'Futari 是專為兩個人設計的帳本，支援多種分攤模式、即時同步，讓同住費用記得清楚、兩個人都看得到。不需要靠群組訊息追帳。',
          },
          {
            question: '同住費用怎麼記才不會出問題？',
            answer: '每筆費用當下記下來，標記誰付的、怎麼分。Futari 會自動累計餘額，任何時候都知道目前的狀態，不用等月底才結算。',
          },
          {
            question: 'Futari 要收費嗎？',
            answer: '基本功能完全免費，包含雙人帳本、多種分攤模式與即時同步。',
      ...
      'monthly-bills': {
        ...
        painPoints: [
          {
            heading: '「這個月的網路費誰繳了？保險費呢？」',
            body: '固定支出通常由某一方固定繳，另一方感覺跟這些帳無關。Futari 讓每筆固定帳也進入共同帳本，兩個人都看得到。',
          },
          {
            heading: '「每個月固定多少錢出去，算過嗎？」',
            body: '把固定支出記下來才知道每個月的「底線」是多少。Futari 讓你清楚看見固定支出佔了多少，不被零碎消費遮住全局。',
          },
          {
            heading: '「某些帳是對方負擔的，但我不知道是多少。」',
            body: '兩個人的支出透明，才能真正平衡。Futari 讓所有帳——包括固定支出——都進入共同帳本，不再有「我不知道你付了什麼」。',
          },
        ],
        faq: [
          {
          ...
          {
            question: 'Futari 有定期支出提醒功能嗎？',
            answer: 'Futari 支援定期支出規則，可以設定每月固定發生的帳，到時系統會提示確認，讓固定帳不被遺忘。',
          },
          {
            question: 'Futari 要收費嗎？',
            answer: '基本功能完全免費，包含雙人帳本、多種分攤模式與即時同步。',
      ...
      'big-purchases': {
        heroKicker: '大筆支出計畫',
        heroTitle: '這筆大的，要怎麼和對方一起記清楚？',
        heroSubtitle: '換車、旅遊基金、新家電——大筆支出不是日常，但影響大。Futari 讓每項重要花費有地方安放，兩個人都清楚這筆錢怎麼來的。',
        painPoints: [
          {
            heading: '「這台車的費用到底花了多少？」',
            body: '購車金、保險、牌照稅、保養——車的費用分散在不同時間點，很難有全局感。Futari 讓每筆車輛相關費用關聯到你們的愛車，一篩就出來。',
          },
          {
            heading: '「大筆支出混在日常帳裡，月報看起來很奇怪。」',
            body: '旅遊基金、換機、添購家電——這些不是每月固定，放在日常帳裡會讓數字失真。Futari 支援分類與備注，讓大筆支出有脈絡可循。',
          },
          {
            heading: '「這筆是我出的，但後來算起來好像不公平。」',
            body: '大筆支出最容易造成不平衡感。Futari 的分攤功能讓每筆大額費用清楚標記怎麼分，餘額自動更新，不靠感覺靠數字。',
          },
        ],
        faq: [
          {
            question: '大筆支出要怎麼和伴侶一起規劃記帳？',
            answer: '在 Futari 記下每筆大額支出，關聯到對應愛物（如車輛、家電），選好分攤方式，兩個人都即時看到。需要回頭看這項資產花了多少，篩一下就出來了。',
          },
          {
            question: '購車費用怎麼在 Futari 記？',
            answer: '在 Futari 建立你們的車輛作為愛物，之後每筆相關費用關聯到這輛車——購車金、保險、保養都歸在一起，清楚看見這台車的總花費。',
          },
          {
            question: 'Futari 要收費嗎？',
            answer: '基本功能完全免費，包含雙人帳本、多種分攤模式與即時同步。',
      ...
      dining: {
        ...
        painPoints: [
          {
            heading: '「這個月外食花了多少？我根本沒概念。」',
            body: '外食費用每筆不大，但累積起來驚人。Futari 讓每筆飲食支出記下來分類，月底不用猜，看一眼就知道這個月吃了多少。',
          },
          {
            heading: '「吃飯有時候對半，有時候輪流，算不清楚。」',
            body: 'Futari 支援多種分攤方式，每筆記帳時選好怎麼分，不管是對半還是這頓你的，餘額都自動計算。',
          },
          {
            heading: '「我們的飲食消費是不是太多了？」',
            body: '看不到就無法調整。Futari 讓飲食支出被看見，不是為了評判，而是讓兩個人對「現在的狀態」有共同的認識。',
          },
        ],
        faq: [
          {
          ...
          {
            question: '外送費用可以在 Futari 記嗎？',
            answer: '可以。Futari 的餐飲分類涵蓋各種飲食支出，外送、外帶、內用都可以記，分類後清楚看見飲食開銷的全貌。',
          },
          {
            question: 'Futari 要收費嗎？',
            answer: '基本功能完全免費，包含雙人帳本、多種分攤模式與即時同步。',
      ...
      parenting: {
        heroKicker: '育兒費用記帳',
        heroTitle: '每一筆為寶貝花的錢，都值得被記下來。',
        heroSubtitle: '奶粉、尿布、回診、早療——育兒費用比想像中多，也比想像中零碎。Futari 讓兩個人把所有育兒開銷放在一起，清楚看見照顧這個孩子花了什麼。',
        painPoints: [
          {
            heading: '「這個月在孩子身上花了多少？我要想一下。」',
            body: '醫療費、食品、衣物、課程——育兒支出分散在各個類別，很難有整體感。Futari 讓每筆支出關聯到孩子，篩一下就看到全貌。',
          },
          {
            heading: '「帶孩子看診都是我付的，對方記得嗎？」',
        ...
        faq: [
          {
            question: '育兒費用要怎麼和另一半一起記？',
            answer: '在 Futari 建立孩子作為愛物，每筆育兒相關費用關聯到這個孩子，兩個人即時看到、自動分攤，不需要月底才對帳。',
          },
          {
            question: '嬰幼兒費用種類很多，Futari 可以分類嗎？',
            answer: 'Futari 有豐富的支出分類，育兒相關費用可以用醫療、餐飲、購物等分類歸類，每筆也可以關聯到孩子，雙重維度讓費用清晰。',
          },
          {
            question: 'Futari 要收費嗎？',
            answer: '基本功能完全免費，包含雙人帳本、多種分攤模式與即時同步。',
      ...
      'aa-split': {
        heroKicker: 'AA 制雙人記帳',
        heroTitle: 'AA 制沒問題，記清楚才是關鍵。',
        heroSubtitle: '對半分、輪流付、按比例——不管你們用哪種方式，Futari 都能記下來、自動算清楚。',
        painPoints: [
          {
            heading: '「我們說好 AA，但每次結帳都不知道誰欠誰多少。」',
            body: 'AA 制最難的地方不是「決定分法」，而是「執行起來記不清楚」。Futari 讓每筆帳即時記下來，餘額自動累計，誰欠誰多少一眼就知道。',
          },
          {
            heading: '「這頓我付，下頓你付——但次數和金額不一樣。」',
            body: '輪流付帳看起來公平，但金額差異會累積。Futari 讓每筆記帳都有分攤記錄，就算輪流付，餘額也清楚反映實際差距。',
          },
          {
            heading: '「AA 制之外，有些帳是某一方固定負擔的。」',
            body: 'Futari 支援多種分攤模式，同一個帳本裡可以有的帳對半、有的帳全額由某人負擔，不需要另開帳本。',
          },
        ],
        faq: [
          {
            question: 'AA 制記帳用什麼 app 比較好？',
            answer: 'Futari 是專為兩個人設計的帳本，支援 AA 對半、按比例、全額等多種分攤模式，餘額自動計算，清楚知道目前誰欠誰多少，不需要靠記憶或群組訊息追帳。',
          },
          {
            question: '輪流付帳要怎麼在 Futari 記？',
            answer: '每次結帳時記下這筆費用由誰付、分攤方式是什麼（對半或某人全額）。Futari 會累計餘額，讓你隨時知道目前的平衡狀態。',
          },
          {
            question: 'Futari 要收費嗎？',
            answer: '基本功能完全免費，包含雙人帳本、多種分攤模式與即時同步。',
