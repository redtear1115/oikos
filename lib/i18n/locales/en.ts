...
export const en: Translations = {
  ...
  assetSheet: {
    ...
    insurance: {
      ...
      accountValueHint: 'For investment-linked policies — copy from statement',
  ...
  assetDetail: {
    ...
    savings: {
      ...
      accountValueHint: 'Investment-linked · from latest statement',
      recurringSectionTitle: 'Let Futari nudge you',
      recurringSectionHint: 'Turn dividends / annuities into recurring income — just tap to confirm when each one is due.',
      recurringSectionCta: 'Set up recurring income →',
      recurringSectionCtaExisting: '{count} recurring rule(s) set up →',
