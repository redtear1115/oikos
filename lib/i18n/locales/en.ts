...
export const en: Translations = {
  ...
  settings: {
    ...
    dangerZone: {
      ...
      removeCta: 'Remove partner',
      removeFlow: {
        title: 'Remove {partner}',
        body: '{partner} will leave this ledger, and it goes back to just you. A new chapter starts now; earlier records stay in place and you can still look back at them.',
        bullets: [
          '{partner} will no longer see this ledger',
          'Any pending invite links become invalid',
          'Earlier records stay in that chapter — viewable, but no longer editable',
          'This cannot be undone',
        ],
        typePromptPrefix: 'Type "',
        typePromptSuffix: '" to confirm',
        typePlaceholder: 'remove',
        confirmText: 'remove',
        removeButton: 'Remove',
        removing: 'Working…',
        cancel: 'Not now',
      ...
      errors: {
        ...
        onlyMemberACanRemove: 'Only the primary holder can remove a partner',
        balanceNotZero: 'The balance is not settled; you cannot leave yet',
        soloGroup: 'This is already a solo ledger',
        activeTrip: 'This ledger has a trip in progress. Mark it as ended in "Trips" before removing your partner.',
