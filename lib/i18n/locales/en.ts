...
export const en: Translations = {
  ...
  tripSheet: {
    ...
    errors: {
      ...
      defaultMissing: 'Default currency is not in the list',
    ...
    currenciesHint: 'Pick the currencies you\'ll use, choose one as default. Each row: "1 of this currency = N of default" (e.g. 1 JPY ≈ 0.2 TWD).',
    ...
    defaultPill: 'Default',
    chipIsDefault: 'Is default',
    chipSetDefault: 'Set as default',
    usedCountNote: '{n} record(s) logged — delete them first to change',
    defaultLockedNote: 'Has expenses; default cannot change',
    customRow: {
