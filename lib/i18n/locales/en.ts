...
export const en: Translations = {
  ...
  settings: {
    ...
    importData: 'Import from another app',
  ...
  importPage: {
    ...
    back: 'Back',
    pageHeading: 'Bring your history with you',
    pageSubtitle: 'Reads CSV exports from Honeydue, Spendee, and CWMoney. The file is parsed in your browser; nothing is written until you confirm.',
    ...
    upload: {
      prompt: 'Drop a CSV here, or choose a file',
      button: 'Choose CSV',
      constraint: 'Up to 2 MB / 5,000 rows. Parsed on this device.',
      parsing: 'Parsing…',
      parseError: "Couldn't read this file. Confirm it's a CSV and try again.",
      tooLarge: 'File exceeds 2 MB — please split it into smaller files.',
      tooManyRows: 'File exceeds 5,000 rows — please split it into smaller files.',
      detectedHeading: 'Detected',
      detectedSource: 'Source · {source}',
      rowCounts: '{total} rows · {valid} importable · {invalid} with issues',
      previewHeading: 'First 5 rows',
      previewCaption: 'Just a glance. You can adjust mapping in the next step.',
      col: {
        date: 'Date',
        type: 'Type',
        amount: 'Amount',
      ...
      noRowsValid: "This file has no importable rows. Check the format and try again.",
    },
    categoryMap: {
      heading: 'Map categories',
      body: 'Map each CSV category to a Futari one. Best-guess pre-filled — feel free to adjust.',
      empty: "Nothing extra to map for this file.",
      columnFrom: 'CSV category',
      columnTo: 'Futari category',
      unmappedHint: "If left unset, falls back to 'Other'.",
    },
    payerSplit: {
      heading: 'Default payer and split',
      body: 'Applied to rows where the CSV does not specify a payer.',
      payerLabel: 'Default payer',
      payerViewer: 'Me',
      payerPartner: 'Partner',
      splitLabel: 'Default split',
      splitHalf: 'Split evenly',
      splitAllMine: 'All mine',
      splitAllTheirs: 'All theirs',
      soloLockHint: "Solo mode is fixed to 'All mine'. Invite a partner to enable other options.",
      sourceLabel: 'Source label (optional)',
      sourcePlaceholder: 'e.g. honeydue-2026-q1',
    },
    confirm: {
      heading: 'Review and import',
      body: 'Creates a batch record so you can trace the source later.',
      expenseCount: '{n} expense rows',
      incomeCount: '{n} income rows',
      skipCount: '{n} to skip',
      duplicatesHeading: 'Rows that match existing records',
      duplicatesEmpty: 'No collisions with existing records.',
      duplicatesShow: 'Show',
      duplicatesHide: 'Hide',
      skipDuplicatesToggle: 'Skip duplicates automatically',
      skipDuplicatesHint: 'Same date, payer, amount, category, and first 10 chars of note counts as duplicate.',
      checkingDuplicates: 'Checking duplicates…',
      duplicateCheckError: "Duplicate check failed — you can still import.",
    },
    result: {
      successHeading: 'Import complete',
      successBody: 'Your records are in the ledger. Take a look at the records page.',
      counts: '{imported} written · {skipped} skipped',
      goToRecords: 'See records',
      importAnother: 'Import another file',
      errorHeading: "Import didn't complete",
      errorBody: 'The whole batch rolled back — nothing was written.',
      tryAgain: 'Try again',
    },
    sources: {
      honeydue: 'Honeydue',
