...
export const en: Translations = {
  ...
  compactRow: {
    ...
    outingSettled: 'Outing settlement',
  ...
  outing: {
    ...
    foldSettlementNote: 'Outing "{name}" settled',
  ...
  settings: {
    ...
    dangerZone: {
      ...
      errors: {
        ...
        activeOuting: 'This ledger has an outing in progress. Mark it as ended in "Outings" before removing your partner.',
...
2026-05-30,Salary,50000,May,TWD,income`,
  ...
  errors: {
    actions: {
      ...
      amount_invalid: 'Enter a whole number',
      amount_too_large: 'That amount is too large',
      outing_not_found: 'Couldn\'t find this outing',
      outing_not_active: 'This outing has ended',
      outing_epoch_closed: 'This outing belongs to a past chapter. It can only be ended.',
      outing_participant_not_found: 'Couldn\'t find that person',
      outing_participant_limit: 'An outing can have up to 20 people',
      outing_name_empty: 'Outing name is empty',
      outing_name_too_long: 'Outing names can be up to 100 characters',
      outing_participant_name_empty: 'Name is empty',
      outing_participant_name_too_long: 'Names can be up to 40 characters',
      outing_share_empty: 'Pick at least one person to split with',
      outing_settlement_same_party: 'Payer and recipient must be different',
      outing_description_too_long: 'Descriptions can be up to 100 characters',
      outing_currency_changed: 'This outing\'s currency doesn\'t match your ledger\'s base currency, so it can\'t fold back into your main ledger.',
      leave_active_outing: 'End the outing before leaving this chapter',
      ...
      primary_user_not_in_group: 'The primary driver isn\'t part of this ledger',
