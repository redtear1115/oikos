...
2026-05-30,Salary,50000,May,TWD,income`,
  ...
  errors: {
    actions: {
      ...
      outing_currency_changed: 'The ledger\'s base currency changed after this outing started, so it can\'t fold back into your main ledger. Switch the currency back, or delete the outing.',
