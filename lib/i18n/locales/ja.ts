...
export const ja: Translations = {
  ...
  tripSheet: {
    ...
    errors: {
      ...
      defaultMissing: '既定の通貨がリストに含まれていません',
    ...
    currenciesHint: '使う通貨を選び、1 つを既定にします。各行は「1 この通貨 = 何 既定通貨」(例：1 JPY ≈ 0.2 TWD)。',
    ...
    defaultPill: '既定',
    chipIsDefault: '既定です',
    chipSetDefault: '既定にする',
    usedCountNote: '{n} 件の記録あり、削除してから変更してください',
    defaultLockedNote: '支出があるため既定は変更できません',
    customRow: {
      codeAriaLabel: '通貨コード',
      codePlaceholder: 'VND',
      labelAriaLabel: '表示名',
