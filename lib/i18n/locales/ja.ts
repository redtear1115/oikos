  ...
  migrate: {
    ...
    otherSources: {
      ...
      items: {
        ...
        'simple-daily-money': {
          name: '簡単家計簿（簡單記帳）',
          description: '台湾で人気の無料家計簿アプリ。スクショ→CSV で持ち込めます。',
        },
      },
    },
    // TODO(#839): ja workflow copy pending native review; the ChatGPT prompt
    // itself is the English version for now (ja prompt deferred per scope).
    chatgptWorkflow: {
        ...
        comparison: {
          ...
          rows: [
            ...
            },
            {
              feature: 'クラウド同期',
              futari: { label: '✓ リアルタイム', tone: 'yes' },
              other: { label: '△ 版による', tone: 'partial' },
            },
            {
              feature: '完全無料',
              futari: { label: '✓ ずっと', tone: 'yes' },
              other: { label: '△ 広告あり', tone: 'partial' },
            },
            {
              feature: 'データの持ち出し',
              futari: { label: '✓ CSV 書き出し', tone: 'yes' },
              other: { label: '✕ 書き出し不可', tone: 'no' },
            },
          ],
        },
      },
