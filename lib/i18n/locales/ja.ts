...
export const ja: Translations = {
  ...
  termsPage: {
    ...
    outro: 'ご不明な点がございましたら、support@futari.southern-light.dev までお問い合わせください。',
    backHome: '← ホームに戻る',
    privacyLink: 'プライバシーポリシー',
  },
  ...
  privacyPage: {
    ...
    sectionStorageBody: 'データは Supabase のサーバー（日本・東京リージョン）に保存され、暗号化された通信とアクセス制御により保護されています。',
    ...
    sectionRightsBody: '設定ページからいつでもサインアウトまたはアカウントを削除できます。個人データのエクスポートやお問い合わせは、support@futari.southern-light.dev までご連絡ください。',
    outro: 'ポリシーに変更がある場合は、本ページを更新し日付を修正します。ご不明な点がございましたら、support@futari.southern-light.dev までお問い合わせください。',
    backHome: '← ホームに戻る',
    termsLink: '利用規約',
  },
