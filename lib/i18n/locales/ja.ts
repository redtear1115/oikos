...
export const ja: Translations = {
  ...
  assetSheet: {
    ...
    insurance: {
      ...
      accountValueHint: '投資型保険 · 残高通知書から書き写し',
      payCycle: '払込周期',
      payCycleAnnual: '年払',
      payCycleSemi: '半年',
  ...
  assetDetail: {
    ...
    savings: {
      ...
      accountValueHint: '投資型保険 · 最新の残高通知書から',
      recurringSectionTitle: 'システムにリマインドさせる',
      recurringSectionHint: '配当 / 生存給付金を定期収入にして、その時が来たら確認するだけ',
      recurringSectionCta: '定期収入を設定 →',
      recurringSectionCtaExisting: '{count} 件の定期収入を設定済み →',
