...
export const ja: Translations = {
  ...
  importPage: {
    title: '過去の記録を取り込む',
    back: '戻る',
    pageHeading: 'これまでの記録を持って来る',
    pageSubtitle: 'Honeydue、Spendee、CWMoney から書き出した CSV を読み込めます。ファイルはこの端末で解析され、取り込みボタンを押すまで書き込みません。',
    ...
    upload: {
      prompt: 'CSV をここにドロップ、またはファイルを選んでください',
      button: 'CSV を選ぶ',
      constraint: '最大 2 MB / 5,000 行。この端末で解析します。',
      parsing: '解析中…',
      parseError: 'このファイルは読み取れませんでした。CSV か確認してもう一度お試しください。',
      tooLarge: 'ファイルが 2 MB を超えています。小さく分けて取り込んでください。',
      tooManyRows: 'ファイルが 5,000 行を超えています。小さく分けて取り込んでください。',
      detectedHeading: '検出',
      detectedSource: 'ソース · {source}',
      rowCounts: '全 {total} 行 · 取り込み可能 {valid} 行 · 問題あり {invalid} 行',
      previewHeading: '先頭 5 行のプレビュー',
      previewCaption: '一目チェックです。次のステップで詳しく調整できます。',
      col: {
        date: '日付',
        type: '種別',
        amount: '金額',
      ...
      noRowsValid: 'このファイルには取り込めるデータがありません。書式を確認してもう一度お試しください。',
    },
    categoryMap: {
      heading: 'カテゴリを対応づける',
      body: 'CSV のカテゴリを Futari のカテゴリに対応づけます。近い名前から自動で推測し、手動で変えられます。',
      empty: 'このファイルでは追加で対応づけるカテゴリはありません。',
      columnFrom: 'CSV のカテゴリ',
      columnTo: 'Futari のカテゴリ',
      unmappedHint: '未選択は「そのほか」になります',
    },
    payerSplit: {
      heading: '既定の支払者と分担',
      body: 'CSV に支払者情報がない行に、ここで選んだ既定が使われます。',
      payerLabel: '既定の支払者',
      payerViewer: 'わたし',
      payerPartner: '相手',
      splitLabel: '既定の分担',
      splitHalf: '半々で分ける',
      splitAllMine: 'すべて自分',
      splitAllTheirs: 'すべて相手',
      soloLockHint: 'ひとりモードでは「すべて自分」に固定されています。相手が参加すると変更できます。',
      sourceLabel: 'ソースのラベル（任意）',
      sourcePlaceholder: '例：honeydue-2026-q1',
    },
    confirm: {
      heading: '確認して取り込みを開始',
      body: '「バッチ」記録を作成し、あとから出どころを確認できます。',
      expenseCount: '支出 {n} 行',
      incomeCount: '収入 {n} 行',
      skipCount: 'スキップ {n} 行',
      duplicatesHeading: '既存の記録と重複する行',
      duplicatesEmpty: '既存の記録と一致する行はありません。',
      duplicatesShow: '展開',
      duplicatesHide: '折りたたむ',
      skipDuplicatesToggle: '重複する行を自動でスキップする',
      skipDuplicatesHint: '同じ日付・同じ支払者・同じ金額・同じカテゴリ・メモ先頭 10 文字が同じ行を重複と見なします。',
      checkingDuplicates: '重複をチェック中…',
      duplicateCheckError: '重複チェックに失敗しました。そのまま取り込みできます。',
    },
    result: {
      successHeading: '取り込みが完了しました',
      successBody: '家計簿に反映されています。記録ページで確認できます。',
      counts: '書き込み {imported} 行 · スキップ {skipped} 行',
      goToRecords: '記録を見る',
      importAnother: 'もう一つ取り込む',
      errorHeading: '取り込みが完了しませんでした',
      errorBody: '今回のデータはまとめてロールバックされ、何も書き込まれていません。',
      tryAgain: 'もう一度試す',
    },
    sources: {
      honeydue: 'Honeydue',
