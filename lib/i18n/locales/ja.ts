...
export const ja: Translations = {
  ...
  landing: {
    ...
    jsonLdFaq: [
      ...
      },
      {
        question: 'データは安全ですか？',
        answer:
          '家計簿はふたりだけに公開されます。通信は HTTPS で暗号化し、マイナンバーや住所などの機微な項目は暗号化して保存します。内容の共有・販売はしません。',
      },
    ],
  ...
  // [ja pending native review]
  outingList: {
    title: 'おでかけ',
    subtitle: 'みんなを誘って、お金のことは一緒にすっきりと。',
    sectionActive: '進行中',
    sectionPast: '過去のおでかけ',
    endedTag: '終了',
    countTag: '{count} 人',
    addCta: 'おでかけを作る',
    empty: {
      heading: 'まだおでかけがありません',
      body: '友だちと出かけるとき、おでかけを作れば、誰が何を払って誰が誰に返すのか、一緒にはっきり見えます。',
    },
  },
  ...
  outing: {
    ...
    untitledExpense: '支出',
    emptyExpenses: 'まだ支出がありません。',
    addExpense: '記録する',
    addParticipant: '人を追加',
    settle: '返済を記録',
    endOuting: 'おでかけを終了',
    endedNote: 'このおでかけは終了しました。',
    coupleFoldNote: '終了すると、ふたりの間の {amount} はメイン台帳に戻ります。',
    endConfirmTitle: 'このおでかけを終了',
    foldSettlementNote: 'おでかけ「{name}」の精算',
    memberFallbackName: 'メンバー',
    endConfirmBody: '終了すると支出を追加できなくなります。ふたりの間の分はメイン台帳に戻り、友だちの分はここで精算します。',
    form: {
      nameLabel: 'おでかけ名',
      namePlaceholder: '例：九份 2 日',
      saveCreate: '開始',
      payerLabel: '支払った人',
      amountLabel: '金額',
      splitLabel: '分担する人',
      descriptionLabel: 'メモ（任意）',
      participantNameLabel: '名前',
      participantNamePlaceholder: '友だちの名前',
      saveParticipant: '追加',
      saveExpense: '保存',
      settleFromLabel: '返す人',
      settleToLabel: '返す相手',
  ...
  settings: {
    ...
    dangerZone: {
      ...
      errors: {
        ...
        activeOuting: 'この家計簿には進行中のおでかけがあります。「おでかけ」で終了にしてから相手を外してください。',
  ...
  invite: {
    ...
    errors: {
      ...
      activeTrip: 'あなたの家計簿には進行中の旅行があります。「旅行」で終了にしてから招待を受けてください。',
      unknown: '家計簿に参加できません',
    },
    meta: {
      // TODO(i18n): native review pending (#1016) — MT-quality draft.
  ...
  termsPage: {
    ...
    bullets: [
      ...
      '設定ページからいつでもサインアウトまたはアカウントを削除できます。削除の申請には14日間の猶予期間があり、その間は取り消せます。期間が過ぎると、おひとりの家計簿は家計簿ごと削除され、パートナーと共有している家計簿は相手に残ります——おふたりで一緒に書いた記録は削除されません。詳しくはプライバシーポリシーの「データの保存期間」をご覧ください。',
  ...
  privacyPage: {
    ...
    sectionCollectItems: [
      'Google または Apple のサインインから提供される基本アカウント情報：氏名、アバター、メールアドレス。',
    ...
    sectionStorageBody: 'データは Supabase がホストするサーバーに保存され、暗号化された通信で送信し、アクセス制御により保護しています。次の項目は、データベースへの書き込み前に AES-256-GCM で暗号化します：お子さまの本名、マイナンバー、健康保険証番号、車のナンバープレート、自宅住所、電子インボイスキャリアの認証コード。これら以外の記録——取引のメモ、金額、カテゴリ、精算のメモなど——は平文で保存します。暗号化も復号も当サービスのサーバー上で行い、鍵は当方が保管します。保存時の暗号化であり、エンドツーエンド暗号化ではありません。',
    sectionRetentionTitle: 'データの保存期間',
    sectionRetentionBody: 'アカウントが有効な間、お客様のデータは継続して保存されます。削除した取引記録はソフトデリートとして約1年間保持され、その後システムにより自動的に消去されます。設定ページからアカウント削除を申請すると14日間の猶予期間（営業日ではなく暦日）があり、その間はいつでも取り消せます。期間が過ぎるとシステムが自動的に実行します。そのとき何が起きるかは、家計簿がおひとりのものか、パートナーと共有しているものかによって異なります：',
    sectionRetentionItems: [
      'おひとりの家計簿：家計簿ごと削除されます——取引、精算、定期収支のルール、愛物と旅行の記録はすべて削除され、お客様のプロフィール（名前、アイコン、メールアドレス）も併せて削除されます。',
      '共有の家計簿：家計簿は相手に残ります。おふたりで一緒に書いた取引・精算・愛物の記録は相手の家計簿に残り、当方が一方的に削除することはありません。それらの記録は相手のものでもあるからです。お客様のログイン情報（Google／Apple アカウントの連携、メールアドレス、アイコン、プッシュ通知の端末）は削除され、お名前は相手の家計簿で「退出したパートナー」と表示されます。',
      '共有の家計簿にある内容も併せて削除したい場合は、アカウントを削除する前にパートナーとご相談いただくか、まず当方までご連絡ください。',
    ],
...
2026-05-30,給与,50000,5月,TWD,income`,
  ...
  errors: {
    actions: {
      ...
      amount_invalid: '金額は整数で入力してください',
      amount_too_large: '金額が大きすぎます',
      outing_not_found: 'このおでかけが見つかりません',
      outing_not_active: 'このおでかけは終了しています',
      outing_epoch_closed: 'このおでかけは過去の章にあるため、終了のみできます',
      outing_participant_not_found: 'この参加者が見つかりません',
      outing_participant_limit: 'おでかけは最大 20 人までです',
      outing_name_empty: 'おでかけの名前が空です',
      outing_name_too_long: 'おでかけの名前は 100 文字までです',
      outing_participant_name_empty: '名前が空です',
      outing_participant_name_too_long: '名前は 40 文字までです',
      outing_share_empty: '割り勘する人を 1 人以上選んでください',
      outing_settlement_same_party: '支払う人と受け取る人は別にしてください',
      outing_description_too_long: '説明は 100 文字までです',
      outing_currency_changed: 'このおでかけの通貨が家計簿の基準通貨と一致しないため、メイン台帳に戻せません。',
      leave_active_outing: 'おでかけを終了してから章を離れてください',
      ...
      primary_user_not_in_group: '主な使用者がこの家計簿のメンバーではありません',
