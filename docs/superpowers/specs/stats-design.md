...
related_issues: "#22"
note: v0.14.0 主題「沒有訊號的時候，也還看得見」的中段；#44 月度回顧 query 形狀沿用本 spec。Drill-down（點 detail bar → feed filter）data attributes 已預留；PR #116 已 merge 進 main 但暫時從 v0.14.1 revert，留到 v0.14.2 一起 deploy（closes #102）。
---
