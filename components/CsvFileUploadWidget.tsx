...
const VARIANTS: Record<'sm' | 'md', Variant> = {
  ...
  md: {
    ...
    prompt: 'text-[15px] mb-3',
    button:
      'inline-flex items-center justify-center h-11 px-6 rounded-xl text-white text-[14px] font-medium',
    buttonStyle: {
      background: 'var(--btn-primary-bg)',
      letterSpacing: '0.6px',
      boxShadow: '0 10px 24px -10px rgba(58, 36, 25, 0.4)',
    },
    errorWrap: 'rounded-2xl px-5 py-4 text-[14px] text-center',
    errorStyle: {
      background: 'var(--surface)',
      border: '1px solid var(--hairline)',
      color: 'var(--ink)',
