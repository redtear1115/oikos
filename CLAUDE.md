...
**Latest released: v1.6.2** — 版本歷史見 [CHANGELOG.md](CHANGELOG.md)（1.0.0 起算；v0.x 只在 git tag）
...
| 版本 | 主題 |
|---|---|
| [v1.6.3](https://github.com/redtear1115/oikos/milestone/81) | 安全性補強（章節邊界、發票載具、金鑰輪替）與其餘 v1.6.0 延續項 |
