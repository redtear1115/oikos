...
export function PendingExpenseCard({ pending, onEdit }: PendingExpenseCardProps) {
  ...
  const handleEditClick = () => {
    if (editDisabled) {
      // PR #4 wires AddSheet 「改一下」 prefill flow; surface intent for now.
      console.warn('[PendingExpenseCard] Edit-and-confirm UI not yet wired')
      return
    }
    onEdit?.(pending)
  }
      ...
      >
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            disabled={submitting || editDisabled}
